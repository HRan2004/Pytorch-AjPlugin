...
public class DebugYoloActivity extends AppCompatActivity implements Runnable {
    private int mImageIndex = 0;
    private String[] mTestImages = {"test1.jpg"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_debug_yolo);
        ...
        buttonSelect.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(DebugYoloActivity.this);
        ...
        buttonLive.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                final Intent intent = new Intent(DebugYoloActivity.this, ObjectDetectionActivity.class)
        ...
        mButtonDetect.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                Thread thread = new Thread(DebugYoloActivity.this);
                thread.start();
            }
        });
    ...
    public void run() {
        ...
        final ArrayList<OdResult> odResults =  PrePostProcessor.outputsToNMSPredictions(outputs, mImgScaleX, mImgScaleY, mIvScaleX, mIvScaleY, mStartX, mStartY);

        runOnUiThread(() -> {
            mButtonDetect.setEnabled(true);
            mButtonDetect.setText(getString(R.string.detect));
            mProgressBar.setVisibility(ProgressBar.INVISIBLE);
            mResultView.setResults(odResults);
